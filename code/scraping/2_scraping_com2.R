...
data[[13]] <- append(data[[13]], "NA", after = 1)
...
a <- paste(x[[8]][[9]],x[[8]][[10]],x[[8]][[11]], sep = " ")
x[[8]] <- x[[8]][-c(9,10,11)]
x[[8]] <- append(x[[8]], a, after = 8)

a <- paste(x[[9]][[4]],x[[9]][[5]],x[[9]][[6]], sep = " ")
x[[9]] <- x[[9]][-c(4,5,6)]
x[[9]] <- append(x[[9]], a, after = 3)
a <- paste(x[[9]][[5]],x[[9]][[6]],x[[9]][[7]], sep = " ")
x[[9]] <- x[[9]][-c(5,6,7)]
x[[9]] <- append(x[[9]], a, after = 4)
