...
data[[26]] <- append(data[[26]], "15 Settembre 2021", after = 3)
...
a <- rep("9 (Agricoltura)", 10)
x[[24]] <- a
x[[24]][10] <- "9 (Agricoltura) ; 14 (Unione Europea)"
...
y[[6]][7] <- "UNCI Agroalimentare ; COLDIRETTI ; AGRINSIEME"
...
y[[19]][7] <- "Associazione Città del Bio"

y[[20]][2] <- "Coldiretti ; FAI ; INU ; Legambiente ; LIPU ; Slow Food Italia ; Touring Club Italiano ; WWF"
...
y[[21]][9] <- "Prof.ssa Adriana GALDERISI, Professore associato di Tecnica e Pianificazione Urbanistica dell'Università degli Studi della Campania Vanvitelli ; Prof. Carmelo DAZZI, Professore di Scienze Agrarie dell'Università degli Studi di Palermo"
...
y[[22]][1] <- " Prof. Fabio CASTELLI, Presidente della Scuola di ingegneria e ordinario di idrologia e costruzioni idrauliche dell'Università degli Studi di Firenze ; Prof. Terribile, Professore di pedologia dell'Università degli Studi Federico II di Napoli"

y[[23]][6] <- "WWF Italia"

y[[24]] <- append(y[[24]], "CNA Confederazione Nazionale dell'Artigianato e della Piccola e Media Impresa", after = 6)
y[[24]][9] <- "MIPAAFT, ICQRF ; MIPAAFT, DIQPAI"
...
y[[26]][4] <- "Autorità Garante della Concorrenza e del Mercato ; Agrinsieme ; Confcommercio ; Federdistribuzione-Ancc Coop-Ancd Conad ; Confartigianato"
...
# Dataframe Commissione 9
c9 <- data.frame(COMMISSIONE=a, NOMI=b, ATTO=c, DATA=d)

write.csv(c9, "[path]/audizioni_informali/data/raw_data/senato/commissione9.csv", row.names = FALSE)
