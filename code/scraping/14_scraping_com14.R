...
a <- rep("A.S. 822 Disposizioni per l'adempimento degli obblighi derivanti dall'appartenenza dell'Italia all'U.E.", 2)
x[[10]] <- append(x[[10]], a, after = 1)
x[[10]][5] <- "Immigrazione ; Bilancio UE"
...
x[[10]][5] <- "14 (Unione Europea) ; XIV (Pol. Unione Europea)"
...
x[[2]][8] <- "Ferdinando Nelli Feroci, co Presidente del Comitato scientifico per il futuro dell'Europa ; Movimento Federalista europeo-Associazione Gioventù Federalista europea"
...
x[[3]][1] <- "CONFETRA Friuli-Venezia Giulia ; Presidente del Consiglio regionale del Friuli-Venezia Giulia ; Autorità di Sistema Portuale del Mare Adriatico Orientale"
...
x[[3]][4] <- "Roberto Rustichelli, Presidente dell'Autorità Garante della Concorrenza e del Mercato ; Giovanni Salvi, Procuratore Generale della Suprema Corte di Cassazione ; CONSOB ; IGI Istituto Grandi Infrastrutture"
...
x[[7]][9] <- "CIA ; Coldiretti ; Confagricoltura ; COPAGRI ; Federalimentare ; Unaitalia ; Assalzoo ; Assica ; Prof. Ferdinando Albisinni, Università degli Studi della Tuscia ; Federdistribuzione ; Centromarca"
x[[7]][10] <- "LAPET ; BCC ; ABI ; Assonime ; Assogestioni ; Prof. Massimiliano Marzo, Università degli Studi di Bologna"
...
x[[9]][9] <- "SIAE Società Italiana degli Autori ed Editori ; ANIE Federazione Nazionale Imprese Elettrotecniche ed Elettroniche ; AIFA Agenzia Italiana del Farmaco ; Agenzia delle Dogane e dei Monopoli"
x[[9]][10] <- "ISTAT"
...
write.csv(c14, "C:/Users/pc/Desktop/Progetto Audizioni/data/raw_data/commissione14.csv", row.names = FALSE)
