...
c6 <- read.csv("C:/Users/pc/Desktop/Progetto Audizioni/data/raw_data/commissione6.csv", header = TRUE, stringsAsFactors = FALSE)
...
write.csv(new_data, "C:/Users/pc/Desktop/Progetto Audizioni/data/preprocessed_data/C6.csv", row.names = FALSE)
