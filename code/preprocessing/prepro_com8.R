...
c8 <- read.csv("C:/Users/SImone/Desktop/audizioni_informali/data/raw_data/commissione8.csv", header = TRUE, stringsAsFactors = FALSE)
...
write.csv(new_data, "C:/Users/SImone/Desktop/audizioni_informali/data/preprocessed_data/C8.csv", row.names = FALSE)
