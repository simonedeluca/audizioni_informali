...
c11 <- read.csv("[path]/audizioni_informali/data/raw_data/senato/commissione11.csv", header = TRUE, stringsAsFactors = FALSE)
...
write.csv(new_data, "[path]/audizioni_informali/data/clean_data/senato/C11.csv", row.names = FALSE)
