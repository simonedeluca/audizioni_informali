...
c8 <- read.csv("[path]/audizioni_informali/data/raw_data/senato/commissione8.csv", header = TRUE, stringsAsFactors = FALSE)
...
write.csv(new_data, "[path]/audizioni_informali/data/clean_data/senato/C8.csv", row.names = FALSE)
