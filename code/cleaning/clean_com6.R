...
c6 <- read.csv("C:/Users/SImone/Desktop/audizioni_informali/data/raw_data/commissione6.csv", header = TRUE, stringsAsFactors = FALSE)
...
write.csv(new_data, "C:/Users/SImone/Desktop/audizioni_informali/data/preprocessed_data/C6.csv", row.names = FALSE)
