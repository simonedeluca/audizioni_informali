...
write.xlsx(senato,"C:/Users/SImone/Desktop/audizioni_informali/data/preprocessed_data/dataset_senato.xlsx", sheetName="Dati", col.names=TRUE, row.names=FALSE, append=FALSE, showNA=TRUE, password=NULL)
