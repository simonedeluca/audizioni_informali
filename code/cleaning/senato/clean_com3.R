...
c3 <- read.csv("[path]/audizioni_informali/data/raw_data/senato/commissione3.csv", header = TRUE, stringsAsFactors = FALSE)
...
write.csv(new_data, "[path]/audizioni_informali/data/clean_data/senato/C3.csv", row.names = FALSE)
